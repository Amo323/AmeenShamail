...
const projects = {
  ...
  4: {
    ...
    category: "Web Development",
    description: "Building it while leveraging the power of AI-assisted development techniques using LLMs for code generation, debugging, and documentation. Letting AI do the magic while I do the planing, design, and other task if the LLM made no or small mistakes. (May–Jun 2025)",
